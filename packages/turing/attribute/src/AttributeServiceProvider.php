 ...
 * @package Turing\Attribute
 */
class AttributeServiceProvider extends BaseRouteServiceProvider
{
    /**
    ...
    public function boot()
    {
        ...
        $this->app->when(Resource::class)
            ->needs('$resource')
            ->give(AttributeResource::class);

        $this->app->when(AttributeController::class)
