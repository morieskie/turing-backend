...
use Turing\Backend\Exceptions\FailedHttValidationException as ValidationException;
...
class Handler extends ExceptionHandler
{
    ...
    protected $internalDontReport = [
        ...
        FailedHttValidationException::class
    ];
    ...
    public function render($request, Exception $e)
    {
        ...
        if ($e instanceof HttpResponseException) {
            ...
            return $this->_convertValidationExceptionToResponse($e, $request);
        }
     ...
     * @return \Symfony\Component\HttpFoundation\Response
     */
    protected function _convertValidationExceptionToResponse(ValidationException $e, $request)
    {
        if ($e->response) {
            return $e->response;
        }
        ...
        return $request->expectsJson()
            ? $this->_invalidJson($request, $e)
            : $this->_invalid($request, $e);
    }
     ...
     * @return \Illuminate\Http\Response
     */
    protected function _invalid($request, ValidationException $exception)
    {
     ...
     */
    protected function _invalidJson($request, ValidationException $exception)
    {
...
//            "message" => FailedHttValidationException::USER_ERROR_CODES[$this->getErrorCode($e->getMessage())],
//            "field" => strstr(strtolower($e->getMessage()), 'token') ? 'API-KEY' : 'USER-KEY'
//        ];
